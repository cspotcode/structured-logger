...
Worth it to allow pairing a message with field types?  something like <code>const message = logMessage<{duration: number}>(`Took too long, took {duration} seconds`);</code>
